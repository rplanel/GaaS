...
- `inputs: Ref<AnalysisInputWithStoragePathRow[] | null>` - Analysis input datasets with storage paths
- `outputs: Ref<AnalysisOutputWithStoragePathRow[] | null>` - Analysis output datasets with storage paths
